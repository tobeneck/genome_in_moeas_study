...
'''
random_inds_d4 = (np.random.random((pop_size-1, 4)) - 0.5) * 2
random_inds_d8 = (np.random.random((pop_size-1, 8)) - 0.5) * 2
random_inds_d16 = (np.random.random((pop_size-1, 16)) - 0.5) * 2
random_inds_d32 = (np.random.random((pop_size-1, 32)) - 0.5) * 2
