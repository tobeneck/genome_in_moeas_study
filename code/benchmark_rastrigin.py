...
seed_ind_d4_df = pd.read_csv("../data/seed_individuals/seed_individuals_Rastrigin_4.csv")
seed_ind_d8_df = pd.read_csv("../data/seed_individuals/seed_individuals_Rastrigin_8.csv")
seed_ind_d16_df = pd.read_csv("../data/seed_individuals/seed_individuals_Rastrigin_16.csv")
seed_ind_d32_df = pd.read_csv("../data/seed_individuals/seed_individuals_Rastrigin_32.csv")
    ...
    for crossover_name in crossovers:#iterate over the crossovers
        for index, seed_ind_data in seed_ind_dfs[dim].iterrows():#iterate over the seed individuals in this generation
            ...
            for i in range(31):#31 re-runs as usual
                ...
                #print output:
                callback.finalize("../data/rastrigin_function_data")
