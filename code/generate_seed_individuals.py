...
#UF ============================================================================================================================================================
UF_seed_types = ["e1", "c", "e2"]

#problems
UF_1 = UF1(n_var = n_var)
UF_2 = UF2(n_var = n_var)
UF_3 = UF3(n_var = n_var)

save_dataframe(UF_1._calc_pareto_set(n_pareto_points=3), random_inds_x, UF_1, "UF1", UF_seed_types, random_types)
save_dataframe(UF_2._calc_pareto_set(n_pareto_points=3), random_inds_x, UF_2, "UF2", UF_seed_types, random_types)
save_dataframe(UF_3._calc_pareto_set(n_pareto_points=3), random_inds_x, UF_3, "UF3", UF_seed_types, random_types)
...
#problems
ZDT_1 = ZDT1(n_var = n_var)
ZDT_2 = ZDT2(n_var = n_var)
ZDT_3 = ZDT3(n_var = n_var)

#save DFs
save_dataframe(ZDT_inds_x, random_inds_x, ZDT_1, "ZDT1", ZDT_seed_types, random_types)
save_dataframe(ZDT_inds_x, random_inds_x, ZDT_2, "ZDT2", ZDT_seed_types, random_types)
save_dataframe(ZDT_inds_x, random_inds_x, ZDT_3, "ZDT3", ZDT_seed_types, random_types)
